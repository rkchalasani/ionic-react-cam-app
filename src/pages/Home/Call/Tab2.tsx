...
import { add, addCircleSharp, bookmark, chatbubble, ellipsisVertical, heart, menu, search } from 'ionicons/icons';
    ...
    <IonPage>
      <IonContent className='feed-content' fullscreen>
        <IonRow className="search-row">
          <IonCol> <IonLabel >Feed</IonLabel></IonCol>
        ...
        <IonGrid className='feed-grid'>
          <IonCard className='feed-card' color='darkgreen'>
            <IonRow className="danni-row">
              ...
              <IonCol className="col1">
                ...
                <IonLabel color='light' className="danni-label">@dannihopkins717</IonLabel>
              </IonCol>
              <IonIcon className='menu-icon' color='light' icon={ellipsisVertical}></IonIcon>
            </IonRow>
          ...
          <IonCard className='feed-card' color='darkgreen'>
            <IonRow className="danni-row">
              <IonImg className="danni-img" src="assets/images/pro3.jpg"></IonImg>
              <IonCol className="col1">
                <IonLabel color='light' className="danni-label">Danni Hopkins</IonLabel>
                <IonLabel color='light' className="danni-label">@dannihopkins717</IonLabel>
              </IonCol>
